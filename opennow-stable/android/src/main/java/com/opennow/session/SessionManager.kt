...
class SessionManager constructor(
    ...
    private var _inputProcessor: com.opennow.input.InputProcessor? = null

    fun setInputProcessor(inputProcessor: com.opennow.input.InputProcessor) {
        _inputProcessor = inputProcessor
    }

    fun getInputProcessor(): com.opennow.input.InputProcessor {
