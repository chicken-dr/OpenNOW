...
class ResourceManager {
    ...
    fun acquireWakeLock(context: Context) {
        ...
        wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "OpenNOW::WakeLock")
        wakeLock?.acquire()
    }
    ...
    fun acquireWifiLock(context: Context) {
        ...
        wifiLock = wm.createWifiLock(android.net.wifi.WifiManager.WIFI_MODE_FULL_HIGH_PERF, "OpenNOW::WifiLock")
        wifiLock?.acquire()
    }
